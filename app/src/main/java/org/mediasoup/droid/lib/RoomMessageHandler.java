...
class RoomMessageHandler {
  ...
  RoomMessageHandler() {
    this.roomContext = RoomContext.getInstance();
  }
      ...
      case "producerScore":
        {
          ...
          roomContext.setProducerScore(producerId, score);
          break;
        }
      case "newPeer":
        {
          ...
          roomContext.addPeer(id, data);
          roomContext.addNotify(displayName + " has joined the room");
          break;
        }
      case "peerClosed":
        {
          String peerId = data.getString("peerId");
          roomContext.removePeer(peerId);
          break;
        }
      case "peerDisplayNameChanged":
        {
          ...
          roomContext.setPeerDisplayName(peerId, displayName);
          roomContext.addNotify(oldDisplayName + " is now " + displayName);
          break;
        }
      case "consumerClosed":
        {
